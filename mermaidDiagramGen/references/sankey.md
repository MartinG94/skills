...
### Label Style (version-dependent; verify renderer support)
...
### Node Width and Padding (version-dependent; verify renderer support)
...
### Custom Node Colors (version-dependent; verify renderer support)
