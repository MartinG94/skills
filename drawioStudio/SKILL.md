...
name: drawioStudio
description: >-
  Diseña, genera, sincroniza incrementalmente, audita y publica modelos y diagramas de arquitectura en
  formato editable .drawio (diagrams.net). Aplica Diagram IR con perfiles de procedencia, preserva la
  diagramación y coordenadas manuales en actualizaciones (diagramctl sync), proyecta múltiples vistas (ejecutiva,
  sistema, despliegue, datos, seguridad C4), realiza Architecture-as-Test en CI, simula fallos (what-if) y
  extrae automáticamente diagramas desde AST de código (Python, TS/JS, Go, Rust), IaC (Terraform, K8s, Docker)
  y esquemas de datos (SQL DDL a ERD, OpenAPI). Usar siempre que se solicite crear, actualizar, sincronizar o auditar
  diagramas en draw.io.
license: MIT
allowed-tools: [Bash, Read, Write, WebFetch]
metadata: {"author":"Agents365-ai / Antigravity","version":"3.2.1","category":"design","platforms":["windows","macos","linux"]}
---
