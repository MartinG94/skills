...
flowchart TD
    ...
    subgraph Gestion_y_Mejora_Procesos["Gestión & Mejora de Procesos (GMP)"]
        ...
        VVC[virtualValueChain<br/><i>E1: Cadena de Valor Virtual</i>]
...
| [**virtualValueChain**](virtualValueChain/SKILL.md) | Skill atómica para el modelado, diagnóstico, diseño y validación de la Cadena de Valor Virtual en Etapa 1 de GMP. | Encuadre organizacional (Matriz 1 PlanillaMATRICES), transformación de información en 5 procesos (Recopilar, Organizar, Seleccionar, Sintetizar, Distribuir), cruce bidimensional físico-virtual (La Matriz del Valor), 3 fases de madurez digital y Lógica Dominante del Servicio (SDL). | Matriz canónica persistida deterministamente en 'cadena_valor_virtual.md' y validada por CLI. |
