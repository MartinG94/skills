...
| [`process-map`](processMap/SKILL.md) | se construye, clasifica y valida el Mapa de Procesos Institucional en los 3 niveles canónicos (Estratégicos, Operativos y Soporte) con sus objetivos y diagrama visual Mermaid | relevamiento institucional, áreas funcionales y alcance | mapa canónico en 'mapa_procesos.md', bloque Mermaid y preselección de procesos candidatos |
...
1. **Etapa 1 — Situación Actual y Selección Ponderada del Proceso Crítico:**
   ...
   - `processMap`: construye y valida el Mapa de Procesos institucional estructurado en 3 niveles canónicos (Estratégicos, Clave/Operativos, Soporte) con diagrama Mermaid embebido, requisitos y satisfacción del cliente, y tabla descriptiva con objetivos y dueños, guardando deterministamente `mapa_procesos.md`.
